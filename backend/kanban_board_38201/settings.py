"""
Django settings for kanban_board_38201 project.
...
ROOT_URLCONF = 'kanban_board_38201.urls'
...
WSGI_APPLICATION = 'kanban_board_38201.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kanban_board_38201 API",
    "DESCRIPTION": "API documentation for kanban_board_38201 App",
    "VERSION": "v1",
}
